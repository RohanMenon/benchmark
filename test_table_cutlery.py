...
bowl_path = os.path.join(script_dir, "assets/bowl.usd")
plate_path = os.path.join(script_dir, "assets/plate.usd")
spoon_path = os.path.join(script_dir, "assets/spoon.usd")

for path, name in [(table_path, "桌子"), (bowl_path, "碗"), (plate_path, "盘子"), (spoon_path, "勺子")]:
...
try:
    while simulation_app.is_running():
        ...
        if count == 1800 and not scene_saved:
            from pxr import Usd
            save_path = os.path.join(script_dir, "assets/saved_table_cutlery_scene.usd")
