...
# 获取文件路径
table_path = os.path.join(os.path.dirname(__file__), "assets/table_edit.usd")
letter_path = os.path.join(os.path.dirname(__file__), "assets/A_edit.usd")
...
print("✓ 物理初始化完成")
print("\n=== 场景检查 ===")
print(f"桌子prim路径: /World/envs/env_0/Table")
print(f"字母prim路径: /World/envs/env_0/Letter_A")
...
try:
    while simulation_app.is_running():
        ...
        if count % 100 == 0:
            # 打印桌子和字母的位置
            print(f"步数 {count}")
            print(f"  桌子路径: /World/envs/env_0/Table")
            print(f"  字母路径: /World/envs/env_0/Letter_A")
